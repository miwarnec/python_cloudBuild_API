...
from swagger_client.apis.buildtargets_api import BuildtargetsApi


class TestBuildtargetsApi(unittest.TestCase):
    """ BuildtargetsApi unit test stubs """

    def setUp(self):
        self.api = swagger_client.apis.buildtargets_api.BuildtargetsApi()

    def tearDown(self):
        pass

    def test_add_build_target(self):
        """
        Test case for add_build_target

        Create build target for a project
        """
        pass

    def test_delete_build_target(self):
        """
        Test case for delete_build_target
    ...
    def test_get_build_target(self):
        """
        Test case for get_build_target
    ...
    def test_get_build_targets(self):
        """
        Test case for get_build_targets

        List all build targets for a project
        """
        pass

    def test_get_build_targets_for_org(self):
        """
        Test case for get_build_targets_for_org

        List all build targets for an org
        """
        pass

    def test_update_build_target(self):
        """
        Test case for update_build_target
