...
from swagger_client.apis.userdevices_api import UserdevicesApi
...
class TestUserdevicesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = swagger_client.apis.userdevices_api.UserdevicesApi()
    ...
    def test_list_devices_for_user(self):
        """
        Test case for list_devices_for_user
