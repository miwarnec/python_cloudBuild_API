...
from swagger_client.apis.orgs_api import OrgsApi
...
class TestOrgsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = swagger_client.apis.orgs_api.OrgsApi()
    ...
    def test_regenerate_ssh_key(self):
        """
        Test case for regenerate_ssh_key
