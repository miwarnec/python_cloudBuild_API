...
class TestOrgsorgidprojectsprojectidbuildtargetsSettingsAdvancedUnityPlayerSettingsAndroid(unittest.TestCase):
    ...
    def testOrgsorgidprojectsprojectidbuildtargetsSettingsAdvancedUnityPlayerSettingsAndroid(self):
        """
        Test OrgsorgidprojectsprojectidbuildtargetsSettingsAdvancedUnityPlayerSettingsAndroid
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = swagger_client.models.orgsorgidprojectsprojectidbuildtargets_settings_advanced_unity_player_settings_android.OrgsorgidprojectsprojectidbuildtargetsSettingsAdvancedUnityPlayerSettingsAndroid()
        pass
