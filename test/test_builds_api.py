...
from swagger_client.apis.builds_api import BuildsApi
...
class TestBuildsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = swagger_client.apis.builds_api.BuildsApi()
    ...
    def test_get_audit_log_0(self):
        """
        Test case for get_audit_log_0
