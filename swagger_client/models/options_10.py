...
class Options10(object):
    ...
    """
    swagger_types = {
        'builds': 'list[OrgsorgidprojectsprojectidartifactsdeleteBuilds]'
    }
    ...
    def __init__(self, builds=None):
        """
        Options10 - a model defined in Swagger
        """
    ...
    def builds(self):
        """
        Gets the builds of this Options10.

        :return: The builds of this Options10.
        :rtype: list[OrgsorgidprojectsprojectidartifactsdeleteBuilds]
        """
        return self._builds
    ...
    def builds(self, builds):
        """
        Sets the builds of this Options10.

        :param builds: The builds of this Options10.
        :type: list[OrgsorgidprojectsprojectidartifactsdeleteBuilds]
        """
        if builds is None:
            raise ValueError("Invalid value for `builds`, must not be `None`")
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Options10):
            return False
