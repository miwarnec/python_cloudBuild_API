...
class OrgsorgidprojectsprojectidbuildtargetsSettingsAdvancedUnity(object):
    ...
    def __init__(self, pre_export_method=None, post_export_method=None, pre_build_script=None, post_build_script=None, scripting_define_symbols=None, player_exporter=None, player_settings=None, editor_user_build_settings=None, run_unit_tests=None, asset_bundles=None, failed_unit_test_fails_build=None, unit_test_method=None, integration_test_method=None, failed_integration_test_fails_build=None, integration_test_scene_list=None):
        """
