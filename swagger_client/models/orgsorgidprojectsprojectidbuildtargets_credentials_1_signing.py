...
class OrgsorgidprojectsprojectidbuildtargetsCredentials1Signing(object):
    """
    ...
    def __init__(self, credentialid=None):
        """
        OrgsorgidprojectsprojectidbuildtargetsCredentials1Signing - a model defined in Swagger
        """
    ...
    def credentialid(self):
        """
        Gets the credentialid of this OrgsorgidprojectsprojectidbuildtargetsCredentials1Signing.

        :return: The credentialid of this OrgsorgidprojectsprojectidbuildtargetsCredentials1Signing.
        :rtype: str
        """
    ...
    def credentialid(self, credentialid):
        """
        Sets the credentialid of this OrgsorgidprojectsprojectidbuildtargetsCredentials1Signing.

        :param credentialid: The credentialid of this OrgsorgidprojectsprojectidbuildtargetsCredentials1Signing.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, OrgsorgidprojectsprojectidbuildtargetsCredentials1Signing):
            return False
