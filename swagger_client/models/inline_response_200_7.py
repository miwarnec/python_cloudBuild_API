...
class InlineResponse2007(object):
    ...
    def __init__(self, hook_type=None, events=None, config=None, active=True, id=None):
        """
    ...
    def hook_type(self):
        """
        Gets the hook_type of this InlineResponse2007.

        :return: The hook_type of this InlineResponse2007.
        :rtype: str
        """
    ...
    def hook_type(self, hook_type):
        """
        Sets the hook_type of this InlineResponse2007.

        :param hook_type: The hook_type of this InlineResponse2007.
        :type: str
        """
        if hook_type is None:
            raise ValueError("Invalid value for `hook_type`, must not be `None`")
        allowed_values = ["web", "slack"]
        if hook_type not in allowed_values:
            raise ValueError(
                "Invalid value for `hook_type` ({0}), must be one of {1}"
    ...
    def events(self):
        """
        Gets the events of this InlineResponse2007.

        :return: The events of this InlineResponse2007.
        :rtype: list[str]
        """
        return self._events
    ...
    def events(self, events):
        """
        Sets the events of this InlineResponse2007.

        :param events: The events of this InlineResponse2007.
        :type: list[str]
        """
        allowed_values = ["ProjectBuildQueued", "ProjectBuildStarted", "ProjectBuildRestarted", "ProjectBuildSuccess", "ProjectBuildFailure", "ProjectBuildCanceled", "ProjectBuildUpload"]
    ...
    def config(self):
        """
        Gets the config of this InlineResponse2007.

        :return: The config of this InlineResponse2007.
        :rtype: object
        """
        return self._config
    ...
    def config(self, config):
        """
        Sets the config of this InlineResponse2007.

        :param config: The config of this InlineResponse2007.
        :type: object
        """
        if config is None:
    ...
    def active(self):
        """
        Gets the active of this InlineResponse2007.

        :return: The active of this InlineResponse2007.
        :rtype: bool
        """
        return self._active
    ...
    def active(self, active):
        ...
        :param active: The active of this InlineResponse2007.
        :type: bool
        """
