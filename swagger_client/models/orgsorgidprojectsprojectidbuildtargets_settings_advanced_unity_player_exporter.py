...
class OrgsorgidprojectsprojectidbuildtargetsSettingsAdvancedUnityPlayerExporter(object):
    ...
    def __init__(self, scene_list=None, build_options=None):
        """
        OrgsorgidprojectsprojectidbuildtargetsSettingsAdvancedUnityPlayerExporter - a model defined in Swagger
        """
    ...
    def scene_list(self):
        """
        Gets the scene_list of this OrgsorgidprojectsprojectidbuildtargetsSettingsAdvancedUnityPlayerExporter.
        A list of scenes to build overriding those specified in the Build Settings menu of your Unity project.

        :return: The scene_list of this OrgsorgidprojectsprojectidbuildtargetsSettingsAdvancedUnityPlayerExporter.
        :rtype: list[str]
        """
    ...
    def scene_list(self, scene_list):
        ...
        :param scene_list: The scene_list of this OrgsorgidprojectsprojectidbuildtargetsSettingsAdvancedUnityPlayerExporter.
        :type: list[str]
        """
    ...
    def build_options(self):
        """
        Gets the build_options of this OrgsorgidprojectsprojectidbuildtargetsSettingsAdvancedUnityPlayerExporter.
        Unity Editor build options. Use BuildOptions.Development and BuildOptions.AllowDebugging to create a development build.

        :return: The build_options of this OrgsorgidprojectsprojectidbuildtargetsSettingsAdvancedUnityPlayerExporter.
        :rtype: list[str]
        """
    ...
    def build_options(self, build_options):
        ...
        :param build_options: The build_options of this OrgsorgidprojectsprojectidbuildtargetsSettingsAdvancedUnityPlayerExporter.
        :type: list[str]
        """
