...
class SharesApi(object):
    ...
    def get_share_metadata(self, shareid, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_share_metadata(shareid, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str shareid: (required)
        ...
        if kwargs.get('callback'):
            return self.get_share_metadata_with_http_info(shareid, **kwargs)
        else:
            (data) = self.get_share_metadata_with_http_info(shareid, **kwargs)
            return data

    def get_share_metadata_with_http_info(self, shareid, **kwargs):
        """
        Get details on shared build including download link
        This is an endpoint accessible without an api key that provides information about a specific build including download links. A shareid is generated by POSTing to a <a href=\"#!/builds/createShare\">build's share endpoint</a>.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_share_metadata_with_http_info(shareid, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_share_metadata" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'shareid' is set
        if ('shareid' not in params) or (params['shareid'] is None):
            raise ValueError("Missing the required parameter `shareid` when calling `get_share_metadata`")
        ...
        if 'shareid' in params:
            path_params['shareid'] = params['shareid']
        ...
        return self.api_client.call_api('/shares/{shareid}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
