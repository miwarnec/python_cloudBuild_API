...
class ConfigApi(object):
    ...
    def list_unity_versions(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_unity_versions(callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.list_unity_versions_with_http_info(**kwargs)
        else:
            (data) = self.list_unity_versions_with_http_info(**kwargs)
            return data

    def list_unity_versions_with_http_info(self, **kwargs):
        """
        List all unity versions
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_unity_versions_with_http_info(callback=callback_function)
        ...
        return self.api_client.call_api('/versions/unity', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_xcode_versions(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_xcode_versions(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.list_xcode_versions_with_http_info(**kwargs)
        else:
            (data) = self.list_xcode_versions_with_http_info(**kwargs)
            return data

    def list_xcode_versions_with_http_info(self, **kwargs):
        """
        List all xcode versions
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_xcode_versions_with_http_info(callback=callback_function)
        ...
        return self.api_client.call_api('/versions/xcode', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
