...
class OrgsApi(object):
    ...
    def get_billing_plans(self, orgid, **kwargs):
        """
        Get billing plan
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_billing_plans(orgid, callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.get_billing_plans_with_http_info(orgid, **kwargs)
        else:
            (data) = self.get_billing_plans_with_http_info(orgid, **kwargs)
            return data

    def get_billing_plans_with_http_info(self, orgid, **kwargs):
        """
        Get billing plan
        Get the billing plan for the specified organization
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_billing_plans_with_http_info(orgid, callback=callback_function)
        ...
        return self.api_client.call_api('/orgs/{orgid}/billingplan', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_ssh_key(self, orgid, **kwargs):
        """
        Get SSH Key
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_ssh_key(orgid, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_ssh_key_with_http_info(orgid, **kwargs)
        else:
            (data) = self.get_ssh_key_with_http_info(orgid, **kwargs)
            return data

    def get_ssh_key_with_http_info(self, orgid, **kwargs):
        """
        Get SSH Key
        Get the ssh public key for the specified org
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_ssh_key_with_http_info(orgid, callback=callback_function)
        ...
        return self.api_client.call_api('/orgs/{orgid}/sshkey', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def regenerate_ssh_key(self, orgid, **kwargs):
        """
        Regenerate SSH Key
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.regenerate_ssh_key(orgid, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.regenerate_ssh_key_with_http_info(orgid, **kwargs)
        else:
            (data) = self.regenerate_ssh_key_with_http_info(orgid, **kwargs)
            return data

    def regenerate_ssh_key_with_http_info(self, orgid, **kwargs):
        """
        Regenerate SSH Key
        Regenerate the ssh key for the specified org *WARNING* this is a destructive operation that will permanently remove your current SSH key.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.regenerate_ssh_key_with_http_info(orgid, callback=callback_function)
        ...
        # verify the required parameter 'orgid' is set
        if ('orgid' not in params) or (params['orgid'] is None):
            raise ValueError("Missing the required parameter `orgid` when calling `regenerate_ssh_key`")
        ...
        return self.api_client.call_api('/orgs/{orgid}/sshkey', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
