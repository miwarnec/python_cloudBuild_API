...
# **get_build_log**
> get_build_log(orgid, projectid, buildtargetid, number, offsetlines=offsetlines, linenumbers=linenumbers, compact=compact, with_html=with_html)
...
try: 
    # Get build log
    api_instance.get_build_log(orgid, projectid, buildtargetid, number, offsetlines=offsetlines, linenumbers=linenumbers, compact=compact, with_html=with_html)
except ApiException as e:
